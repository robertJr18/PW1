...
public class BookingItemDtos {
    public record BookingItemCreateRequest(BigDecimal price, Integer segmentOrder, Cabin cabin,Long bookng_id,Long flight_id) implements Serializable {}
    public record BookingItemUpdateRequest(Long id, BigDecimal price, Integer segmentOrder, Cabin cabin,Long bookng_id,Long flight_id ) implements Serializable {}
